...
var createBlogg = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, title, content) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          alert("please fill all the fields", _context.t0.response.data.message);
        case 10:
        case "end":
  ...
  return function createBlogg(_x, _x2, _x3) {
...
// })
exports.createBlogg = createBlogg;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var updateBlogg = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, title, content, id) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://localhost:3000/update-blog/".concat(id),
            data: {
              name: name,
              title: title,
              content: content
        ...
        case 3:
          res = _context.sent;
          if (res.data.status == "success") {
            (0, _alerts.showAlert)("Updated Successfully!");
            window.setTimeout(function () {
              location.assign("/blog/".concat(id));
            });
          }
          _context.next = 10;
          break;
  ...
  return function updateBlogg(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
// })
exports.updateBlogg = updateBlogg;
...
var update = document.querySelector('.form-update');
...
if (create) {
  create.addEventListener('submit', function (e) {
    ...
    (0, _create.createBlogg)(name, title, content);
  });
}
if (update) {
